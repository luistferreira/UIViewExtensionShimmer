...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of UIViewExtensionShimmer.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Rafael Costa/UIViewExtensionShimmer'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Rafael Costa' => 'rafael@rafaelcosta.me' }
  s.source           = { :git => 'https://github.com/Rafael Costa/UIViewExtensionShimmer.git', :tag => s.version.to_s }
